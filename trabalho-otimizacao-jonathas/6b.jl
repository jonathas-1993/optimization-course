# 6b.jl - Sudoku com menos de 20 valores iniciais (18)
...
# Restrições padrão (célula, linha, coluna, bloco)
...
println("Solução final (18 valores iniciais):")
for i in 1:9
    println(sol[i, :])
end